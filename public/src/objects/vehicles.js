class Vehicle extends Phaser.Physics.Matter.Sprite{
    constructor(scene,x,y) {
        ...
        const lWall =  Bodies.rectangle(w*0.20,h*0.20,w*0.10,h*0.40);
        const mWall =  Bodies.rectangle(w*0.50,h*0.40,w*0.50,h*0.15, {chamfer: {radius: 2}});
        const rWall =  Bodies.rectangle(w*0.80,h*0.20,w*0.10,h*0.40);

        const compoundBody = Body.create({
            parts: [lWall,mWall,rWall],
            frictionStatic: 0.01,
            frictionAir: 0.01,
            friction: 0.01,
            density: 0.1,
